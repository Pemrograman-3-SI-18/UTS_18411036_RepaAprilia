<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <q-header class="bg-blue-grey-1 text-blue-grey-6">
      <q-toolbar>
            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">Repa Aprilia</div>
                </div>
              </div>
              ...
              <div class="column items-center">
                ...
                <q-btn
                  color="teal"
                  label="Keluar" to="/pendaftar/login"
                  unelevated
                  size="sm"
                  v-close-popup>
    ...
    <q-drawer
      ...
      :breakpoint="500"
      show-if-above
      content-class="bg-yellow text-teal-10"
    >
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-red-1 text-bold">
            <q-item-section>
              UAI
            </q-item-section>
          </q-item>
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              <q-avatar size="200px" class="q-mb-md">
                <img src="statics/lol.jpg" alt="">
              </q-avatar>
              <div>Universitas April Indonesia</div>
            </div>
          </q-item>
          <q-item-label
            header
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/datadiripeserta">
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/inputedit">
            <q-item-section avatar>
              <q-icon name="input" />
            </q-item-section>
            <q-item-section>
